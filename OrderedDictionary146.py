"""
Twitch 146. LRU Cache: https://leetcode.com/problems/lru-cache/description/
...
# OrderedDict() is the easiest solution for a constant runtime:
class LRUCache:
    def __init__(self, capacity):
        self.capacity = capacity
        self.values = OrderedDict() # keeps the last used item last
